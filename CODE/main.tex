...
\begin{figure}[h]{Sơ đồ hệ thống NILM}
    \centering
    \includegraphics[width=0.9\linewidth]{IMAGE/Sơ đồ NILM.jpg}
\end{figure}
...
\begin{figure}[h]{Kết quả phân loại sử dụng thuật toán WAMMA chỉ xét đến mô hình}
    \centering
    \includegraphics[width=1\linewidth]{IMAGE/ket_qua_he_thong/image9.png}
\end{figure}
...
\begin{figure}[h]{Kết quả toàn bộ hệ thống sử dụng thuật toán sự kiện WAMMA}
    \centering
    \includegraphics[width=1\linewidth]{IMAGE/ket_qua_he_thong/image10.png}
\end{figure}
...
\begin{figure}[h]{Kết quả phân loại sử dụng thuật toán Hybrid của Mengqi Lu và Zuyi Li chỉ xét đến mô hình}
    \centering
    \includegraphics[width=1\linewidth]{IMAGE/ket_qua_he_thong/image11.png}
\end{figure}
\textbf{Kết quả đánh giá toàn bộ hệ thống}
\begin{itemize}
    \item F1 Score: 73\%
...
\begin{figure}[h]{Kết quả toàn bộ hệ thống sử dụng thuật toán sự kiện Hybrid của Mengqi Lu và Zuyi Li}
    \centering
    \includegraphics[width=1\linewidth]{IMAGE/ket_qua_he_thong/image12.png}
\end{figure}
...
\begin{figure}[h]{Kết quả phân loại sử dụng thuật toán đề xuất chỉ xét đến mô hình}
    \centering
    \includegraphics[width=1\linewidth]{IMAGE/ket_qua_he_thong/image13.png}
\end{figure}
\textbf{Kết quả đánh giá toàn bộ hệ thống}
\begin{itemize}
    \item F1 Score: 84\%
...
\begin{figure}[h]{Kết quả toàn bộ hệ thống sử dụng thuật toán sự kiện đề xuất}
    \centering
    \includegraphics[width=1\linewidth]{IMAGE/ket_qua_he_thong/image14.png}
\end{figure}
