...
\textbf{Chương 2: Tổng quan thuật toán NILM đề xuất} – Mô tả kiến trúc và các thành phần chính của thuật toán, bao gồm khối phát hiện sự kiện, tiền xử lý và trích xuất đặc trưng, nhận dạng thiết bị. Chương này cũng nêu ưu điểm nổi bật và các hạn chế cùng hướng khắc phục.
