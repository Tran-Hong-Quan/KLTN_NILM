...
Mặc dù NILM đã được nghiên cứu trong nhiều năm, nhưng phần lớn các hệ thống hiện tại vẫn chỉ giải quyết một phần của bài toán. Nhiều công trình chỉ tập trung vào phát hiện thiết bị thay đổi trạng thái hoặc chỉ tập trung vào trích xuất đặc trưng và phân loại thiết bị, chứ không xây dựng đầy đủ toàn bộ quy trình từ đầu đến cuối. Ngoài ra, các nghiên cứu còn đặt ra giả định đơn giản hóa rằng trong một thời điểm chỉ có một thiết bị duy nhất bật hoặc tắt. Giả định này giúp thuật toán dễ xử lý hơn, nhưng lại không phù hợp với môi trường thực tế – nơi nhiều thiết bị có thể hoạt động và thay đổi trạng thái gần như đồng thời, khiến tín hiệu bị chồng lấn và gây khó khăn cho việc nhận dạng.

Trước những hạn chế đó, đề tài này phát triển một hệ thống NILM hoàn chỉnh, bao gồm toàn bộ chuỗi xử lý:
\begin{enumerate}
    \item Phát hiện thời điểm thiết bị thay đổi trạng thái
    \item Trích xuất đặc trưng của chính thiết bị đó từ tín hiệu tổng
    \item Phân loại, nhận diện loại thiết bị tương ứng
\end{enumerate}

Đây là điểm khác biệt quan trọng, vì hệ thống không chỉ thực hiện một phần của quy trình mà kết nối toàn bộ các bước lại thành một hệ thống thống nhất, có thể hoạt động từ đầu đến cuối.

Bên cạnh đó, đề tài cũng xây dựng một phương pháp trích xuất đặc trưng mới trong môi trường phức tạp, nơi nhiều thiết bị đang hoạt động đồng thời. Các nghiên cứu trước thường phải giả sử rằng đã có sẵn thuật toán trích xuất đặc trưng trong môi trường nhiều thiết bị, hoặc đơn giản hóa điều kiện bằng cách yêu cầu chỉ có một thiết bị hoạt động tại một thời điểm. Ngược lại, hệ thống trong đồ án được thiết kế để tự xử lý tín hiệu chồng lấn, tách ra đặc trưng của sự kiện thực sự xảy ra và duy trì độ chính xác nhận dạng ngay cả khi tín hiệu nhiễu hoặc lẫn nhiều thiết bị.
