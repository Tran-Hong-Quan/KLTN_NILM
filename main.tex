...
Thuật toán đề xuất đạt TPP = 100\%, tức không bỏ lỡ bất kỳ sự kiện nào (FNN = 0\%). Kết quả này cho thấy hệ lai ghép (kết hợp WAMMA + Low-Decrease + các ràng buộc thời gian) đã khắc phục tốt hạn chế của từng phương pháp gốc. Cụ thể:
